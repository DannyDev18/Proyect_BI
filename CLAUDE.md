...
> **Última actualización de este documento:** 2026-07-14 (Comisiones Variables: nuevo esquema de comisión por margen/categoría/crédito/tipo de vendedor sobre el módulo Metas y Comisiones, con piloto en sombra y rollback vía `COMISION_MODO`; ver `docs/features/plan_integracion_comisiones_variables.md` y `docs/auditoria/30_comisiones_variables.md`).
