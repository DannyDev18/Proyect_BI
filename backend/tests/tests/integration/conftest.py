...
# inteligente.md): el flag apaga /ruta/* por defecto en producción (rollback §9), pero
# la suite de integración sí debe ejercitar esos endpoints -- debe fijarse ANTES de que
# cualquier test importe `app.main` (el router se registra una sola vez, al importar).
os.environ.setdefault("CARTERA360_RUTA_INTELIGENTE_ENABLED", "true")
